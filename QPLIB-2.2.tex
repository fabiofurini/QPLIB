...
Our taxonomy is based on a three-fields code of the form ``\textit{FVC}'', where \textit{F} indicates the objective function, \textit{V} the variables, and \textit{C} the constraints of the problem. The fields can be given the following values:\todo{\small Ambros: maybe OVC instead of FVC?}
%
\begin{itemize}
...
% are available  that can be able to 

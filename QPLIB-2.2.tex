...
\todo[inline]{subsubsection has some title as subsection}
...
\begin{itemize}
 ...
 %
 \item variables: (C)ontinuous only, (B)inary only, (M)ixed binary and continuous, (I)nteger only, (G)eneral (all three types\todo{or mixed integer and continuous?});
 %

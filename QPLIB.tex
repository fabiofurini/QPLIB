...
\begin{abstract}
 This paper describes a new instance library for Quadratic Programming (QP), i.e., the family of continuous and (mixed)-integer optimization problems where either the objective function or the constrains (or both) are quadratic.

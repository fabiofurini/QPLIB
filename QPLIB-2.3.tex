...
%dubbing \emph{exact} a solver that employ 
...
%
 \item {\sc KNitro\_bb}, {\sc BonMin}, {\sc sBB}, {\sc XPress}, {\sc GuRoBi}, which implement complete BB algorithms for CGC. {\bf how about {\sc mosek}?}
\end{itemize}
%

...
\begin{itemize}
 ...
 \item \emph{Second Instances Filter.}\\
       ...
       keep computationally challenging instances we ran a complete solver for QGQ with a time limit of 120 seconds; all the
...
terms of number of variables and constraints. \textcolor{red}{The record on the maximal number of variables and constraints (both $\approx 1,000,000$) is set by the instances 8547 and 9008.}
...
parser (provided)\todo{SV: what is meant by ``(provided)''?}, it typically produces smaller files, and it permits the

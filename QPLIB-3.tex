...
the instances with a quadratic objective function, ordered by 
 percentage of ``problematic'' \textcolor{red}{(defined using a tollerance of XXX)} \todo{please define the tolerance used to identify the ``Problematic'' eigenvalues and change the label of the plot}\ eigenvalues in the Hessian $Q^0$ (vertical axis), by which

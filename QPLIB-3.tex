...
%\todo{AG: maybe cite CBLIB paper \cite{Friberg2016} SV: then we would have to add citations for all mentioned libraries (where available)}
...
parser, 
%(provided)\todo{SV: what is meant by ``(provided)''?}, 

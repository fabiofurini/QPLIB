...
it produces smaller files. See the Appendix~\ref{sec:format} for more details.
...
Additional details on the instance features can be found in the Appendix~\ref{sec:instance_details}.
%- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
%- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
%  End QPLIB-3.tex
%- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

...
Note that this might occasionally lead us to classify some instances that have conic constraints as non-convex ones, although their feasible region is in fact convex; however, only some solvers are capable of properly exploiting this property.
...
\textcolor{red}{We now analyse the features of the instances selected to be part of the

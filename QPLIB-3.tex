...
\begin{itemize}
\item percentage of negative eigenvalues of the $Q^0$ matrix,  % (\emph{\% neg eig}),
\item density of the $Q^0$ matrix . %(\emph{\% dens}).
\end{itemize}
...
This information allowed us to analyze the gathered instances and to perform the filters described in the the next paragraph.
...
global optimality.
%n this step, we decided to use the broadest set of solvers able to tackle the different categories of quadratic problems.\\

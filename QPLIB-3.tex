...
The number of positive (i.e., larger than $10^{-16}$) and negative (i.e., smaller than $-10^{-16}$) eigenvalues of $Q^0$ allowed us to identify the
...
Note that this might might occasionally lead us to classify some instances that have conic constraints as non-convex ones, although their feasible region is in fact convex---fortunately, only some solvers are capable of properly exploiting this property.
...
Beyond the example instances, the website provides a rich set of metadata for

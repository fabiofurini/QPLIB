...
Solvers in Table \ref{t:solvers} that implement complete cutting plane methods for CGC are \alphaecp \cite{westerlund}, \bonmin (in the algorithmic mode B-OA) \cite{BBCCGLLLMSW} and \dicopt \cite{quesada}. \todo{here we give references to the solvers, above we don't}

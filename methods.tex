...
\sqic \cite{Gill2015}
for nonconvex ones
While there are many different approaches for continuous NLPs in general, we mention here those that are particularly well-suited for QP, i.e.:
%
\begin{itemize}
...
\end{itemize}
%
Active set and interior point methods have been defined for *C* but also for general (continuous) NLPs, and many of the solvers named above target this

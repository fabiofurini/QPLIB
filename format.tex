...
\item [{[6]}]
For problems of type \texttt{*B*} and for variables that are specified explicitly as binary variables, the default values for lower and upper bounds of a binary variables are assumed to be 0 and 1, respectively, independent of the specification of $l_d$ and $u_d$.
%Note, that in case of \texttt{*I*}, binary variable need to be specified as general integer variables with bounds 0 and 1.
\end{description}

...
\item [{[2]}]
for BQPs, IBQPs, and MIBQPs, these sections are omitted.
\item [{[3]}]
for LPs, QCPs, ILPs, IQCPs, MILPs, MIQCPs, this section is omitted.
\item [{[4]}]
for LPs, BQPs, QPs, ILPs, IBQPs, IBQPs, MILPs, MIBQPs, MIBQPs, this section is omitted.
\item [{[5]}]

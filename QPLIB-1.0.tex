...
%
\bottomrule 
\multicolumn{3}{l}{\multirow{1}{\textwidth}{$^{\ddagger}$Applications with many manuscripts cite reviews and recent works.}} \\ \\ \\
\endlastfoot
%
